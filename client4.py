...
play_bg = transform.scale(loading_bg, (WIDTH, HEIGHT))

game_over_bg = image.load("game/images/game_over.jpg")
game_over_bg = transform.scale(loading_bg, (WIDTH, HEIGHT))

two_players_bg = image.load("game/images/2_players.webp")
two_players_bg = transform.scale(loading_bg, (WIDTH, HEIGHT))
# --- ЗВУКИ ---
